...
// $Rev: 8291 $
// File generated on 5/19/2008 9:01:50 AM from Type Library described below.
...
// *********************************************************************//
  IExodusController = interface(IDispatch)
    ...
    function SelectRoom(const Title: WideString; IncludeAnyOption: WordBool): WideString; safecall;
...
// *********************************************************************//
  IExodusControllerDisp = dispinterface
    ...
    function SelectRoom(const Title: WideString; IncludeAnyOption: WordBool): WideString; dispid 232;
  end;
