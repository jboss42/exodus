...
// File generated on 12/12/2002 7:26:29 AM from Type Library described below.
...
//   (3) v1.0 ExodusPlugins, (D:\src\exodus\exodus\plugins\ExodusPlugin.tlb)
// ************************************************************************ //
...
uses Windows, ActiveX, Classes, ExodusPlugins_TLB, Graphics, StdVCL, Variants;
...
// *********************************************************************//
  IExodusController = interface(IDispatch)
    ...
    function RegisterCallback(const xpath: WideString; var callback: OleVariant): Integer; safecall;
...
// *********************************************************************//
  IExodusControllerDisp = dispinterface
    ...
    function RegisterCallback(const xpath: WideString; var callback: OleVariant): Integer; dispid 4;
...
// *********************************************************************//
  IExodusChatDisp = dispinterface
    ...
    function RegisterPlugin(const Plugin: ExodusChatPlugin): Integer; dispid 3;
